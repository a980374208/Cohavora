...
QString LocalizeTelemetryDisplayText(const QString &value) {
	static const QHash<QString, QString> translations = {
		...
		{QStringLiteral("IMPLEMENTED_DETERMINISTIC"), QCoreApplication::translate("TelemetryDisplay", "IMPLEMENTED_DETERMINISTIC")},
		{QStringLiteral("PARTIAL_PRODUCT_CHAIN"), QCoreApplication::translate("TelemetryDisplay", "PARTIAL_PRODUCT_CHAIN")},
		{QStringLiteral("UNSUPPORTED_CURRENT_PROVIDER"), QCoreApplication::translate("TelemetryDisplay", "UNSUPPORTED_CURRENT_PROVIDER")},
		{QStringLiteral("CONTROLLED_HARNESS_ONLY"), QCoreApplication::translate("TelemetryDisplay", "CONTROLLED_HARNESS_ONLY")},
		{QStringLiteral("DEFERRED_EXTERNAL"), QCoreApplication::translate("TelemetryDisplay", "DEFERRED_EXTERNAL")},
		...
		{QStringLiteral("admission_to_startup_terminal_chain_implemented"), QCoreApplication::translate("TelemetryDisplay", "admission_to_startup_terminal_chain_implemented")},
		{QStringLiteral("subscription_first_media_observation_window_implemented"), QCoreApplication::translate("TelemetryDisplay", "subscription_first_media_observation_window_implemented")},
		{QStringLiteral("admission_connect_subscription_to_render_chain_implemented"), QCoreApplication::translate("TelemetryDisplay", "admission_connect_subscription_to_render_chain_implemented")},
		{QStringLiteral("reconnect_episode_density_implemented"), QCoreApplication::translate("TelemetryDisplay", "reconnect_episode_density_implemented")},
		{QStringLiteral("typed_anomaly_density_implemented"), QCoreApplication::translate("TelemetryDisplay", "typed_anomaly_density_implemented")},
		{QStringLiteral("fine_grained_session_stages_not_instrumented"), QCoreApplication::translate("TelemetryDisplay", "fine_grained_session_stages_not_instrumented")},
		{QStringLiteral("typed_operation_failure_reason_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "typed_operation_failure_reason_not_exposed")},
		{QStringLiteral("remote_control_ack_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "remote_control_ack_not_exposed")},
		{QStringLiteral("recovery_transport_subscription_share_stages_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "recovery_transport_subscription_share_stages_not_exposed")},
		{QStringLiteral("typed_reconnect_strategy_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "typed_reconnect_strategy_not_exposed")},
		{QStringLiteral("audio_cadence_provider_partial"), QCoreApplication::translate("TelemetryDisplay", "audio_cadence_provider_partial")},
		{QStringLiteral("audio_device_underrun_provider_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "audio_device_underrun_provider_not_exposed")},
		{QStringLiteral("audio_level_clipping_provider_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "audio_level_clipping_provider_not_exposed")},
		{QStringLiteral("apm_effective_state_provider_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "apm_effective_state_provider_not_exposed")},
		{QStringLiteral("playout_delay_provider_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "playout_delay_provider_not_exposed")},
		{QStringLiteral("native_device_failure_category_not_exposed"), QCoreApplication::translate("TelemetryDisplay", "native_device_failure_category_not_exposed")},
		{QStringLiteral("device_selection_category_not_projected"), QCoreApplication::translate("TelemetryDisplay", "device_selection_category_not_projected")},
		{QStringLiteral("process_gpu_provider_not_configured"), QCoreApplication::translate("TelemetryDisplay", "process_gpu_provider_not_configured")},
		{QStringLiteral("crash_evidence_provider_not_configured"), QCoreApplication::translate("TelemetryDisplay", "crash_evidence_provider_not_configured")},
		{QStringLiteral("independent_process_watchdog_not_installed"), QCoreApplication::translate("TelemetryDisplay", "independent_process_watchdog_not_installed")},
		{QStringLiteral("controlled_peer_harness_only"), QCoreApplication::translate("TelemetryDisplay", "controlled_peer_harness_only")},
		{QStringLiteral("external_optical_environment_required"), QCoreApplication::translate("TelemetryDisplay", "external_optical_environment_required")},
		{QStringLiteral("external_acoustic_environment_required"), QCoreApplication::translate("TelemetryDisplay", "external_acoustic_environment_required")},
		{QStringLiteral("external_av_sync_environment_required"), QCoreApplication::translate("TelemetryDisplay", "external_av_sync_environment_required")},
		...
		{QStringLiteral("admission_not_observed"), QCoreApplication::translate("TelemetryDisplay", "admission_not_observed")},
		{QStringLiteral("waiting_for_startup_terminal"), QCoreApplication::translate("TelemetryDisplay", "waiting_for_startup_terminal")},
		{QStringLiteral("admission_to_startup_terminal_valid"), QCoreApplication::translate("TelemetryDisplay", "admission_to_startup_terminal_valid")},
		{QStringLiteral("admission_to_degraded_startup_terminal_valid"), QCoreApplication::translate("TelemetryDisplay", "admission_to_degraded_startup_terminal_valid")},
		{QStringLiteral("startup_terminal_timeout"), QCoreApplication::translate("TelemetryDisplay", "startup_terminal_timeout")},
		{QStringLiteral("startup_terminal_failure"), QCoreApplication::translate("TelemetryDisplay", "startup_terminal_failure")},
		{QStringLiteral("startup_cancelled"), QCoreApplication::translate("TelemetryDisplay", "startup_cancelled")},
		{QStringLiteral("no_remote_media_binding"), QCoreApplication::translate("TelemetryDisplay", "no_remote_media_binding")},
		{QStringLiteral("no_remote_media_expected"), QCoreApplication::translate("TelemetryDisplay", "no_remote_media_expected")},
		{QStringLiteral("all_expected_subscriptions_delivered_media"), QCoreApplication::translate("TelemetryDisplay", "all_expected_subscriptions_delivered_media")},
		{QStringLiteral("expected_subscription_media_timeout"), QCoreApplication::translate("TelemetryDisplay", "expected_subscription_media_timeout")},
		{QStringLiteral("subscription_observation_origin_missing"), QCoreApplication::translate("TelemetryDisplay", "subscription_observation_origin_missing")},
		{QStringLiteral("waiting_for_expected_subscription_media"), QCoreApplication::translate("TelemetryDisplay", "waiting_for_expected_subscription_media")},
		{QStringLiteral("reconnect_episode_density_valid"), QCoreApplication::translate("TelemetryDisplay", "reconnect_episode_density_valid")},
		{QStringLiteral("typed_anomaly_density_valid"), QCoreApplication::translate("TelemetryDisplay", "typed_anomaly_density_valid")},
		{QStringLiteral("session_never_became_usable"), QCoreApplication::translate("TelemetryDisplay", "session_never_became_usable")},
		{QStringLiteral("usable_duration_warming_up"), QCoreApplication::translate("TelemetryDisplay", "usable_duration_warming_up")},
		{QStringLiteral("usable_duration_not_available"), QCoreApplication::translate("TelemetryDisplay", "usable_duration_not_available")},
		{QStringLiteral("admission_accept_to_startup_terminal"), QCoreApplication::translate("TelemetryDisplay", "admission_accept_to_startup_terminal")},
		{QStringLiteral("subscription_intent_to_first_media"), QCoreApplication::translate("TelemetryDisplay", "subscription_intent_to_first_media")},
		{QStringLiteral("stability-anomaly-density-v1"), QCoreApplication::translate("TelemetryDisplay", "stability-anomaly-density-v1")},
		{QStringLiteral("s9b_fifth_batch_audit"), QCoreApplication::translate("TelemetryDisplay", "s9b_fifth_batch_audit")},
