...
$evidence = Join-Path $workspace "build-debug/evidence/e2ee-interop-20260920/$RunId"
...
try {
    ...
    Write-Output "[MATRIX] run=$RunId mode=$Mode key_state=$KeyState passed=$passed two_peer=$TwoPeer"
